...
//    private MaterialSpinner _tspinner;
    ...
    private BubbleSeekBar mTimeSeekbar;
    private BubbleSeekBar mMoneySeekbar;
    private TextView mTimeSelectTextview;
    private TextView mMoneySelectTextview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_task2);
...
//        _tspinner = (MaterialSpinner) findViewById(R.id.time_spinner);
        ...
        mTimeSeekbar = (BubbleSeekBar) findViewById(R.id.detail_time_limit_seekbar);
        mMoneySeekbar = (BubbleSeekBar) findViewById(R.id.detail_money_seekbar);
        mTimeSelectTextview = (TextView) findViewById(R.id.detail_time_limit_text_view);
        mMoneySelectTextview = (TextView) findViewById(R.id.detail_money_text_view);
        //设置toolbal
    ...
    private void initSeekBar() {
        mScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                mMoneySeekbar.correctOffsetWhenContainerOnScrolling();
                mTimeSeekbar.correctOffsetWhenContainerOnScrolling();
            }
        });

        mMoneySeekbar.setOnProgressChangedListener(new BubbleSeekBar.OnProgressChangedListener() {
            @Override
            ...
            public void getProgressOnFinally(BubbleSeekBar bubbleSeekBar, int progress, float progressFloat) {
                String time = (getResources().getString(R.string.detail_money_select_string));
                mMoneySelectTextview.setText(String.format(time, String.valueOf(progress)));
            }
        });

        mTimeSeekbar.setOnProgressChangedListener(new BubbleSeekBar.OnProgressChangedListener() {
            @Override
            public void onProgressChanged(BubbleSeekBar bubbleSeekBar, int progress, float progressFloat) {
            }
            ...
            @Override
            public void getProgressOnFinally(BubbleSeekBar bubbleSeekBar, int progress, float progressFloat) {
                String time = (getResources().getString(R.string.detail_time_limit_string));
                mTimeSelectTextview.setText(String.format(time, String.valueOf(progressFloat)));
            }
        });
    }
