...
import static com.example.delitto.myapplication.Action.getHistoryAction.GetHistory;
import static com.example.delitto.myapplication.Action.getHistoryAction.getHistoryFlag;
...
public class getHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _listdata = new ArrayList<GetHistoryData>();
        ...
        new AsyncTask<Void, Void, Integer>() {
            ...
            protected Integer doInBackground(Void... params) {
                if (NetworkState.networkConnected(mContext)) {
                    ...
                    GetHistory();
                    String jsonresult=getHistoryFlag();
                    onFinish(jsonresult);
                } else {
