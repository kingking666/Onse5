...
public class QuxiaorenwuPost
{
    // 请求服务器端的url
    private static String PATH = "http://123.207.237.45/webtt/QuxiaoRenwuAction";
    private static URL url;

    public QuxiaorenwuPost() {
   ...
   /*public static void main(String[] args)
    {
        ...
        Iterator it=new Gsonanalyze().getword(po.executeHttpPost("可接"));
        Gson gson = new Gson();
        while (it.hasNext()) {
